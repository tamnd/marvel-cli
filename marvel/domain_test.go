...
// HTTP behaviour is covered in marvel_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "marvel://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("marvel", "about")
	if err != nil || got.String() != "marvel://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want marvel://page/about", got.String(), err)
	}
}
