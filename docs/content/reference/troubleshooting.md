...
Most of these come down to network reality or how marvel serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

marvel rate-limits like any public site. marvel already paces
...
Where a surface is gated, marvel reads a cookie or token you supply
...
`marvel`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what marvel actually did
